...
/**
 * Use this class to poll for comments on a subreddit. By default, a large
 * quantity of recent comments will be returned initially (to prevent this,
 * use the {@link skipExisting} middleware). Additionally, there will be repetition
 * between polls of returned comments (to prevent this, use the {@link skipDuplicates}
 * middleware). This wrapper will poll for comments at a given frequency, but
